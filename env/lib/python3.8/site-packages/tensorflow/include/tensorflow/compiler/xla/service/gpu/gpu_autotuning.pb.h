...
class AlgorithmDenylistEntry final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD ::tensorflow::ComputeCapability* release_cc();
  ...
  ::tensorflow::ComputeCapability* _internal_mutable_cc();
  public:
  void unsafe_arena_set_allocated_cc(
      ::tensorflow::ComputeCapability* cc);
  ::tensorflow::ComputeCapability* unsafe_arena_release_cc();
...
inline const ::tensorflow::ComputeCapability& AlgorithmDenylistEntry::_internal_cc() const {
  const ::tensorflow::ComputeCapability* p = _impl_.cc_;
...
inline ::tensorflow::ComputeCapability* AlgorithmDenylistEntry::release_cc() {
  ...
  ::tensorflow::ComputeCapability* temp = _impl_.cc_;
  _impl_.cc_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::tensorflow::ComputeCapability* AlgorithmDenylistEntry::unsafe_arena_release_cc() {
...
inline ::tensorflow::ComputeCapability* AlgorithmDenylistEntry::_internal_mutable_cc() {
...
inline ::tensorflow::ComputeCapability* AlgorithmDenylistEntry::mutable_cc() {
  ::tensorflow::ComputeCapability* _msg = _internal_mutable_cc();
...
inline ::tensorflow::CudnnVersion* AlgorithmDenylistEntry::unsafe_arena_release_cudnn_version() {
...
inline ::tensorflow::CudnnVersion* AlgorithmDenylistEntry::_internal_mutable_cudnn_version() {
